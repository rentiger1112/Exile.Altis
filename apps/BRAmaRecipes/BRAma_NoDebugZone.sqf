...
switch (WorldName) do
{
    case "Esseker":   { BRAma_upperLimit = 99999; };
    case "Chernarus": { BRAma_upperLimit = 99999; };
	case "Altis": 	  { BRAma_upperLimit = 99999; };
    default           { BRAma_upperLimit = 99999; };	
};

BRAma_isInDebugZone = false;
BRAma_noDebugZoneTime = 3000;
