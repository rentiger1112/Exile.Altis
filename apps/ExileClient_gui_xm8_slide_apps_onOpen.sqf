...
_AppsLogo = "apps\images\xm8logofix_ca.paa";
...
_newControl ctrlSetEventHandler ["ButtonClick", "execVM'apps\XM8Apps_Init.sqf';"];
_newControl ctrlSetStructuredText (parseText (format [""]));
};
