...
//====================== general settings
_folder = "scripts\rearm\"; // folder where the service point scripts are saved, relative to the mission file
_servicePointClasses = ["O_Truck_repair_F","I_Truck_02_box_F","B_Truck_01_Repair_F","B_Slingload_01_Ammo_F","Land_CarService_F","Land_fs_roof_F","Land_fs_feed_F"]; // service point classes (can be house, vehicle and unit classes)
...
/*
		...
		//GH 2000 RND "2000Rnd_65x39_Belt_Tracer_Red",
		"2000Rnd_65x39_Belt_Tracer_Green","2000Rnd_65x39_Belt_Tracer_Yellow",
		//GH 1000 RND
		"1000Rnd_65x39_Belt_Tracer_Green","1000Rnd_65x39_Belt_Tracer_Yellow","1000Rnd_65x39_Belt_Tracer_Red",
		//GH 2000 RND
		"2000Rnd_65x39_Belt_Tracer_Green_Splash","2000Rnd_65x39_Belt_Tracer_Yellow_Splash",
		//PAWNEE 5000 RND
		"5000Rnd_762x51_Belt","24Rnd_missiles",
		//Mi8
		"rhs_mag_762x54mm_2000","rhs_mag_762x54mm_1000","rhs_mag_762x54mm_250","rhs_mag_762x54mm_100",
		//Tank etc
		"rhs_mag_100rnd_127x99_mag_Tracer_Yellow","rhs_mag_100rnd_127x99_mag_Tracer_Green","rhs_mag_100rnd_127x99_mag",
		//Hellfire
		"rhs_mag_FFAR_14","rhs_mag_FFAR_28","rhs_mag_FFAR_38","rhs_mag_FFAR_76","14Rnd_FFAR","28Rnd_FFAR","38Rnd_FFAR","8Rnd_Hellfire"
		*/
];

//cost per magazine for individual vehicles
_rearm_costs = [
    ["B_Heli_Transport_01_F",9250],
		["RHS_UH60M",9250],
		["RHS_UH1Y",9250],
		["RHS_Mi8mt_vvsc",8500],
		["RHS_CH_47F_light",9000],
		["B_Heli_Transport_03_black_F",8250],
		["B_Heli_Light_01_armed_F",9000],
    ["AllVehicles",1000],
    ["Air",10000]
];
