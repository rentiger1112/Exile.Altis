...
_app1Logo = "apps\images\bikeLog.paa"; //The Logo that will Appear on the app button images MUST be in a .paa format
app1_action = {
...
app1_action = {
execVM "apps\APOC_Airdrop_Assistance\APOC_Airdrop_Assistance_XM8.sqf";
};

//App 2
_app2Text = "";
_app2Logo = "apps\images\Stats_IconWhite.paa";
app2_action = {
  execVM"apps\Apps\PlayerStats.sqf";
};
...
//App 3
_app3Text = "";
_app3Logo = "apps\images\info.paa";
app3_action = {
execVM"Apps\Apps\rules.sqf";
};

//App 4
_app4Text = "";
_app4Logo = "apps\BRAmaRecipes\BRAma.paa";
app4_action = {
execVM"Apps\BRAmaRecipes\init.sqf";
};

// app 5
_app5Text = "";
_app5Logo = "apps\ExileSecurity\Images\ExileSecurity.paa";
app5_action = {[] spawn ExileSecurity_territory};
...
_app12Text = "";
_app12Logo = "apps\images\home.paa";
app12_action = {
