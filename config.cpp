...
}; //potential extra comment may need to delete.
	...
	class Flag
	{
		...
		class Actions
		{
			...
			*/
			class Upgrade: ExileAbstractAction
			{
				title = "Upgrade Territory Size";
				condition = "true";
				action = "_this call ExileClient_gui_upgradeterritoryDialog_request";
			class TerritoryInfo: ExileAbstractAction
			{
				title = "View Territory Info";
				condition = "true";
				action = "_this call ExileClient_Custom_fnc_Territory_Info";
				};
			};
		};
	};
...
class CfgTerritories
{
	...
	minimumDistanceToOtherTerritories = 100;
